...
const CompanyTrendsTable = ({ props }) => {
        ...
        <>
          <Box sx={{ width: "100%" }}>
            <Paper sx={{ width: "100%", mb: 2 }}>
              ...
              <TableContainer>
                <Table
                  sx={{ minWidth: 750, bgcolor: "#020817", border: 1.5, borderColor: "white", borderRadius: "10px" }}
                    ...
                    {visibleRows.map((el, index) => {
                      ...
                      return (
                        <TableRow
                          ...
                          <TableCell align='center' style={{ textAlign: "center", color: "white" }}>
...
export default CompanyTrendsTable;
